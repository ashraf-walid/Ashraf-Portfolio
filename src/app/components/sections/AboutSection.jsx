  ...
  return (
    <section id="about" className="min-h-screen grid md:grid-cols-2 px-2 sm:px-4 py-10 sm:py-16">
      ...
      <div className="w-fit max-w-md sm:max-w-lg md:max-w-none h-fit bg-[#232323] rounded-3xl flex flex-col justify-between items-center gap-8 p-6 sm:p-8 mx-auto md:mx-0">
        ...
        <div className="bg-[#1b1b1b] w-full rounded-xl px-4 py-2 flex gap-2 text-sm sm:text-base items-center"> <Mail /> ashrafelgezery2014@gmail.com </div>
        <div className="bg-[#1b1b1b] w-full rounded-xl px-4 py-2 flex gap-2 text-sm sm:text-base items-center"> <Phone /> +20 1000 980 788 </div>
        <div className="bg-[#1b1b1b] w-full rounded-xl px-4 py-2 flex gap-2 text-sm sm:text-base items-center"> <MapPin /> Egypt, Damitta </div>
      </div>
      {/* Get to know me */}
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="text-3xl sm:text-4xl md:text-5xl max-w-full md:max-w-[470px] font-bold">Pasionate about creating web applacation</div>
        ...
        <div className="flex flex-col sm:flex-row justify-between w-full gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="text-xl sm:text-2xl">Bacaloriace Degree</div>
          </div>
          {/* coulm Two */}
          <div className="flex-1">
        ...
        <div className="flex flex-col sm:flex-row mt-8 sm:mt-10 gap-4 sm:gap-6 w-full">
          <button className="bg-slate-100 px-4 sm:px-4 py-3 sm:py-4 rounded-3xl flex gap-3 text-lg sm:text-xl font-bold text-zinc-700 justify-center items-center flex-1">
            <Download/> Download Resume
          </button>
          <button className="px-4 sm:px-4 py-3 sm:py-4 rounded-3xl flex gap-3 text-lg sm:text-xl font-bold text-zinc-200 border-2 border-neutral-200 justify-center items-center flex-2">
