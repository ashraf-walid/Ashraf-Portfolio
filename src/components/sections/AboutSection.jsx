    ...
    <section id="about" className="min-h-screen grid md:grid-cols-2 px-2 sm:px-4 py-10 sm:py-16 overflow-x-hidden">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          Beyond just UI, I engineer complete web solutions. From secure authentication systems to complex data visualization, I leverage modern tools like Next.js 15 and Tailwind to build production-ready software.
        </motion.div>
        <motion.div
          className="text-base sm:text-xl text-gray-300"
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4">15+</div>
            <div className="text-gray-400 text-base sm:text-lg">Technologies</div>
            <div className="text-gray-400 text-base sm:text-lg">Mastered</div>
          </motion.div>
        </motion.div>
        {/* Details */}
        <motion.div
        ...
        >
          <motion.a
            href="/C.V Ashraf Elgezery.pdf" download
